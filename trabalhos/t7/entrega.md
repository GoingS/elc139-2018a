...
Testes do programa [vetor.c](vetor.c)
...
Exemplo de execução do programa [pipeline.c](pipeline.c):
```
...
O primeiro programa usa a tag igual a seu rank. Assim cada processo tem uma tag diferente e nunca vai receber mensagem ou conseguir enviar, pois todas as tags são diferentes.
